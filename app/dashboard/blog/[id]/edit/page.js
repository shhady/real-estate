...
export default function EditBlogPage({ params }) {
  ...
  const handleImageUpload = async (e) => {
    ...
    for (const file of files) {
      ...
      formData.append('folder', 'real-estate/blogs');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(error.message || 'שגיאה בעדכון הפוסט');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">עריכת פוסט</h1>
